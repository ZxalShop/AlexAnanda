...
//
const BotName = 'Bot ./Zxal'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/ff_zxal/'; // ff_zxal
const whatsapplu = '0857-8984-3218'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = https://chat.whatsapp.com/HpKOjRHcyXNGDkGASGUK3t'; // OFFICIAL GRUP LU 1
